...
export const ADAPTERS: Record<string, SiteAdapter | SiteAdapter[]> = { rustypot, csgogem, cases: [cases, casesCrash], clash: [clash, clashCrash], rustclash: [rustclash, rustclashCrash], rusteasy, banditcamp, rustmagic, rustyloot, csgoroll, splits };
