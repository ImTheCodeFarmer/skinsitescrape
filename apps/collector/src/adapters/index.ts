...
export const ADAPTERS: Record<string, SiteAdapter | SiteAdapter[]> = { rustypot, csgogem, cases: [cases, casesCrash], clash: [clash, clashCrash], rusteasy, banditcamp, rustmagic };
