          ...
          {bets.map((b) => {
            ...
            return (
              <MotionRow key={b.id} layout {...rowAnim}>
                ...
                <TableCell><PlayerLink site={site ?? ""} id={b.player.id} name={b.player.name} avatar={b.player.avatar} color={rowMeta?.color ?? color} nameClassName="max-w-[5.5rem] sm:max-w-[10rem]" /></TableCell>
                <TableCell>
                  {(() => {
