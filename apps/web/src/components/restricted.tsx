 ...
 */
export function Restricted({ what, pitch, signedIn }: { what: string; pitch?: string; signedIn: boolean }) {
  return (
    <div className="flex items-start justify-center pt-16 md:pt-32">
      <div className="mx-4 w-full max-w-md rounded-xl bg-card p-6 shadow-border">
        ...
        <h1 className="text-lg font-semibold tracking-tight">{what} are for members</h1>
        {pitch ? <p className="mt-1.5 text-sm">{pitch}</p> : null}
